...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Duralux || Dashboard Guru</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
    <link rel="shortcut icon" type="image/png" href="{{ asset('img/logo-smk.png') }}" />
    <!--! END: Favicon-->
    <!--! BEGIN: Bootstrap CSS-->
...
<body>
    ...
    <div class="theme-customizer">
        ...
        <div class="customizer-sidebar-wrapper">
            ...
            <div class="customizer-sidebar-footer px-4 ht-60 border-top d-flex align-items-center">
                <div class="flex-fill">
                    <a href="javascript:void(0);" class="btn btn-danger w-100"
                        data-style="reset-all-common-style">Reset All Settings</a>
                </div>
            </div>
        </div>
    </div>
    ...
    {{-- Modals from child views (must be outside <main> to avoid stacking context issues) --}}
    @stack('modals')
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.nxl-hasmenu > .nxl-link').forEach(function(link) {
                link.addEventListener('click', function(e) {
                    e.preventDefault();
                    var parentLi = this.closest('.nxl-hasmenu');
                    var isActive = parentLi.classList.contains('active');

                    // Close all open siblings
                    var siblings = parentLi.parentElement.querySelectorAll('.nxl-hasmenu');
                    siblings.forEach(function(sib) {
                        if (sib !== parentLi) {
                            sib.classList.remove('active');
                            var subMenu = sib.querySelector('.nxl-submenu');
                            if (subMenu) {
                    ...
                    if (isActive) {
                        ...
                        var sub = parentLi.querySelector(':scope > .nxl-submenu');
