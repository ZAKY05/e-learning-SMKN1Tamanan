...
<head>
    ...
    <title>Register Admin - SMK Negeri 1 Tamanan</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="row g-0 min-vh-100">
            ...
            <div class="col-lg-6 d-none d-lg-flex left-panel text-white p-5 flex-column justify-content-between">
                ...
                <div>
                    ...
                    <p class="text-white-50 fs-6 lh-base mb-5" style="max-width: 400px;">
                        Daftar untuk mengakses dashboard admin dan mengatur<br>
            ...
            <div class="col-12 col-lg-6 d-flex align-items-center justify-content-center bg-light p-4">
                <div class="w-100" style="max-width: 448px;">
                    ...
                    <!-- Back to Login -->
                    <div class="mb-4">
                        <a href="{{ route('login') }}" class="text-decoration-none text-secondary small d-inline-flex align-items-center gap-1">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!-- NIP -->
                        <div class="mb-3">
                            <label for="nip" class="form-label fw-medium text-dark small">NIP (Nomor Induk Pegawai)</label>
                        ...
                        <!-- Name -->
                        <div class="mb-3">
                            <label for="name" class="form-label fw-medium text-dark small">Full Name</label>
                            <div class="input-group">
                                <span class="input-group-text bg-white border-end-0">
                        ...
                        <!-- Confirm Password -->
                        <div class="mb-3">
                            <label for="password_confirmation" class="form-label fw-medium text-dark small">Confirm Password</label>
                            <div class="input-group">
                                <span class="input-group-text bg-white border-end-0">
                        ...
                        <div class="mb-4">
                            <div class="form-check">
                                ...
                                <label class="form-check-label text-secondary small" for="terms">
                                    Saya setuju dengan <a href="#" class="text-emerald-600 text-decoration-none">Syarat & Ketentuan</a> serta <a href="#" class="text-emerald-600 text-decoration-none">Kebijakan Privasi SMK 1 Tamanan</a>
                                </label>
                            </div>
                        </div>
