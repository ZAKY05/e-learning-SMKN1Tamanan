                ...
                <div class="card stretch stretch-full">
                    <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <h5 class="card-title mb-0" style="font-size:1.05rem;">
                            <i class="feather-key me-2 text-primary" style="font-size:1.15rem;"></i> Manajemen Akun Guru
                        </h5>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0" id="tabelAkunGuru" style="font-size:0.9rem;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="btn btn-soft-warning btn-edit-akun"
                                                    ...
                                                    data-nip="{{ $data->nip }}" data-email="{{ $data->email }}"
                                                    title="Edit Akun"
                ...
                <form action="{{ route('admin.akun-guru.store') }}" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalTambahAkunLabel">
                            <i class="feather-user-plus me-2 text-primary"></i> Tambah Akun Guru
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Pilih Guru <span class="text-danger">*</span></label>
                            ...
                            <small class="text-muted">Hanya menampilkan guru yang belum memiliki akun</small>
                        </div>
                        <div class="mb-3">
                ...
                <form id="formEditAkun" action="" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalEditAkunLabel">
                            <i class="feather-edit me-2 text-warning"></i> Edit Akun Guru
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" id="editNamaGuru" class="form-control bg-light" disabled>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-semibold">NIP</label>
                            <input type="text" id="editNipGuru" class="form-control bg-light" disabled>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Email <span class="text-danger">*</span></label>
            ...
            <div class="modal-content">
                <form id="formHapusAkun" action="" method="POST">
                    ...
                    <div class="modal-body text-center pt-0">
                        ...
                        <h5 class="fw-bold">Hapus Akun Guru</h5>
    ...
    <script>
        ...
        document.querySelectorAll('.btn-edit-akun').forEach(function(btn) {
            btn.addEventListener('click', function() {
                ...
                document.getElementById('editNamaGuru').value = this.dataset.nama;
                document.getElementById('editNipGuru').value = this.dataset.nip;
                document.getElementById('editEmailGuru').value = this.dataset.email;
                document.getElementById('inputPasswordEdit').value = '';
                document.getElementById('formEditAkun').action = '{{ url('admin/akun-guru') }}/' + id;
            });
        });
        ...
        document.querySelectorAll('.btn-hapus-akun').forEach(function(btn) {
            btn.addEventListener('click', function() {
                document.getElementById('namaHapusAkun').textContent = this.dataset.nama;
                document.getElementById('formHapusAkun').action = '{{ url('admin/akun-guru') }}/' + this
                    .dataset.id;
            });
        });
